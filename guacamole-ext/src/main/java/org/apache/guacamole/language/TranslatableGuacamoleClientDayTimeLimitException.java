...
/**
 * A {@link TranslatableGuacamoleClientDayTimeLimitException} whose associated message is
 ...
 */
public class TranslatableGuacamoleClientDayTimeLimitException extends GuacamoleClientDayTimeLimitException implements Translatable {
    ...
    /**
     * Creates a new TranslatableGuacamoleClientDayTimeLimitException with the given
     ...
     */
    public TranslatableGuacamoleClientDayTimeLimitException(String message, TranslatableMessage translatableMessage, Throwable cause) {
        super(message, cause);
     ...
     *     occurred.
     */
    public TranslatableGuacamoleClientDayTimeLimitException(String message, TranslatableMessage translatableMessage) {
        super(message);
        this.translatableMessage = translatableMessage;
    }
     ...
     *     The cause of this exception.
     */
    public TranslatableGuacamoleClientDayTimeLimitException(String message, String key, Throwable cause) {
     ...
     *     displayed in the user's native language.
     */
    public TranslatableGuacamoleClientDayTimeLimitException(String message, String key) {
