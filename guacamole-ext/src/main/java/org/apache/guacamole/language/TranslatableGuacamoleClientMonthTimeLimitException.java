...
/**
 * A {@link TranslatableGuacamoleClientMonthTimeLimitException} whose associated message is
 ...
 */
public class TranslatableGuacamoleClientMonthTimeLimitException extends GuacamoleClientMonthTimeLimitException implements Translatable {
    ...
    /**
     * Creates a new TranslatableGuacamoleClientMonthTimeLimitException with the given
     ...
     */
    public TranslatableGuacamoleClientMonthTimeLimitException(String message, TranslatableMessage translatableMessage, Throwable cause) {
        super(message, cause);
     ...
     *     occurred.
     */
    public TranslatableGuacamoleClientMonthTimeLimitException(String message, TranslatableMessage translatableMessage) {
        super(message);
        this.translatableMessage = translatableMessage;
    }
     ...
     *     The cause of this exception.
     */
    public TranslatableGuacamoleClientMonthTimeLimitException(String message, String key, Throwable cause) {
     ...
     *     displayed in the user's native language.
     */
    public TranslatableGuacamoleClientMonthTimeLimitException(String message, String key) {
